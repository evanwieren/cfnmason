...
module Cfnmason
  class HammerOfTheGods < Thor
    ...
    desc "goodbye NAME", "This will tell you goodbye"
    long_desc <<-GOODBYE_WORLD 

    `goodbye NAME` will print out a message to the person of your choosing.
    ...
    option :upcase
    def goodbye( name )
      leaving = "Goodbye, #{name}"
      leaving.upcase! if options[:upcase]
      puts leaving
    end
  end
end
